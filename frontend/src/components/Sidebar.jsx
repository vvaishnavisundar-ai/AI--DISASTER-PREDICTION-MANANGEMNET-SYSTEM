...
import { Activity, Map, BarChart2, ShieldAlert, Settings, LogOut, X } from 'lucide-react';
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <div className={`w-64 bg-surface border-r border-border h-screen flex flex-col p-4 fixed left-0 top-0 z-50 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
